...
public:
  ...
  /// @note TLS context must be configured via getTlsContext() before calling.
  /// @note TLS verify mode must be set (e.g. set_verify_mode(asio::ssl::verify_none)) unless using a CA-signed cert.
